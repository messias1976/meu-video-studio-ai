...
createRoot(root).render(<React.StrictMode><RuntimeErrorBoundary><><StudioApp/><ProjectSettings/><ProjectNameEditor/><TimelineInteractions/><PreviewComposition/><ExportController/></></RuntimeErrorBoundary></React.StrictMode>)
